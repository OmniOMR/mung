...
setup(
    ...
    packages=[
        ...
        'mung2midi.inference',
        'mung2musicxml',
        'mung2musicxml.grammar_new',
        'mung2musicxml.grammar_new.corrections',
        'mung2musicxml.grammar_new.deprules',
        'mung2musicxml.grammar_new.parts',
        'mung2musicxml.grammar_new.rules',
        'mung2musicxml.grammar_new.rules.impl',
        'mung2musicxml.grammar_new.validators',
        'mung2musicxml.grammar_new.validators_mung',
        'mung2musicxml.grammar_new.violations',
